...
Public Sub GenererRapportGL_Ecriture(wsRapport As Worksheet, noEcritureDebut As Long, noEcritureFin As Long)
    ...
    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modGL_Rapport_Nouveau:GenererRapportGL_Ecriture", noEcritureDebut & " à " & noEcritureFin, 0)
...
Public Sub GenererRapportGL_DateSaisie(wsRapport As Worksheet, dtSaisieDebut As Date, dtSaisieFin As Date)
    ...
    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modGL_Rapport_Nouveau:GenererRapportGL_DateSaisie", dtSaisieDebut & " à " & dtSaisieFin, 0)
