...
Public Sub VerifierIntegriteTablesLocales()
    ...
    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierIntegriteTablesLocales", vbNullString, 0)
    ...
    'Vérification des sessions log (multi-fichiers) ===
    Call AjouterMessageAuxResultats(wsOutput, r, 1, "Vérification des .Log")
    Call AjouterMessageAuxResultats(wsOutput, r, 3, Format$(Now(), "yyyy-mm-dd hh:nn:ss"))
    r = r + 1
    ...
    If fso.folderExists(logFolder) Then
        Dim f As Object
        For Each f In fso.GetFolder(logFolder).Files
            If LCase(f.Name) Like "logmainapp*.log" Then
                Call AjouterMessageAuxResultats(wsOutput, r, 2, f.Name)
                r = r + 1
...
SkipLogs:
    ...
    Else
        MsgBox "La vérification a détecté " & gNombreErreur & " erreurs" & vbNewLine & vbNewLine & "Voir la feuille 'X_Analyse_Intégrité'", vbInformation
    End If
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierIntegriteTablesLocales", vbNullString, startTime)

End Sub

Private Sub VerifierPlanComptable(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierPlanComptable", vbNullString, 0)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierPlanComptable", vbNullString, startTime)

End Sub

Private Sub VerifierClients(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierClients", vbNullString, 0)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierClients", vbNullString, startTime)

End Sub

Private Sub VerifierFournisseurs(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)
    
    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierFournisseurs", vbNullString, 0)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierFournisseurs", vbNullString, startTime)

End Sub

Private Sub VerifierCCRegularisations(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierCCRegularisations", vbNullString, 0)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierCCRegularisations", vbNullString, startTime)

End Sub

Private Sub VerifierDEBRecurrent(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierDEBRecurrent", vbNullString, 0)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierDEBRecurrent", vbNullString, startTime)

End Sub

Private Sub VerifierDEBTrans(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierDEBTrans", vbNullString, 0)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierDEBTrans", vbNullString, startTime)

End Sub

Private Sub VerifierENCDetails(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierENCDetails", vbNullString, 0)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierENCDetails", vbNullString, startTime)

End Sub

Private Sub VerifierENCEntete(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierENCEntete", vbNullString, 0)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierENCEntete", vbNullString, startTime)

End Sub

Private Sub VerifierFACDetails(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierFACDetails", vbNullString, 0)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierFACDetails", vbNullString, startTime)

End Sub

Private Sub VerifierFACEntete(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierFACEntete", vbNullString, 0)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierFACEntete", vbNullString, startTime)

End Sub

Private Sub VerifierFACComptesClients(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierFACComptesClients", vbNullString, 0)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierFACComptesClients", vbNullString, startTime)

End Sub

Private Sub VerifierFACSommaireTaux(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierFACSommaireTaux", vbNullString, 0)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierFACSommaireTaux", vbNullString, startTime)

End Sub

Private Sub VerifierFACProjetsEntete(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierFACProjetsEntete", vbNullString, 0)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierFACProjetsEntete", vbNullString, startTime)

End Sub

Private Sub VerifierFACProjetsDetails(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierFACProjetsDetails", vbNullString, 0)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierFACProjetsDetails", vbNullString, startTime)

End Sub

Private Sub VerifierGLTrans(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierGLTrans", vbNullString, 0)
    ...
    ReDim sum_arr(1 To 10000, 1 To 3)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierGLTrans", vbNullString, startTime)

End Sub

Private Sub VerifierGLEJRecurrente(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierGLEJRecurrente", vbNullString, 0)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierGLEJRecurrente", vbNullString, startTime)

End Sub

Private Sub VerifierTECTdBData(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierTECTdBData", vbNullString, 0)
...
Clean_Exit:
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierTECTdBData", vbNullString, startTime)

End Sub

Private Sub VerifierTEC(ByVal wsOutput As Worksheet, ByRef r As Long, ByRef readRows As Long)

    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierTEC", vbNullString, 0)
    ...
    'Charger toutes les lignes dans un tableau 2D
    ...
    '1. Remplir le dictionnaire (dictClient) pour tous les clients
    ...
    Dim dictHresFactureesTEC As New Dictionary
    ...
    Call ComparerHeuresFactureesSelon2Sources(wsOutput, r, dictFacture, dictHresFactureesTEC, isTECvalid)
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:VerifierTEC", vbNullString, startTime)
...
Sub ImprimerCasProbleme(data As Variant, ByVal wsOutput As Worksheet, ByRef r As Long, _
    ...
    Dim startTime As Double: startTime = Timer: Call modDev_Utils.EnregistrerLogApplication("modVerifications:ImprimerCasProbleme", vbNullString, 0)
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:ImprimerCasProbleme", vbNullString, startTime)
...
Sub ComparerHeuresFactureesSelon2Sources(ByVal wsOutput As Worksheet, ByRef r As Long, _
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:ComparerHeuresFactureesSelon2Sources", vbNullString, 0)
    ...
    Dim ws As Worksheet: Set ws = wsdFAC_Details
    Dim dictHresFactureesFACDetails As Object
    Set dictHresFactureesFACDetails = CreateObject("Scripting.Dictionary")
    
    Dim arrFAC As Variant
    arrFAC = ws.ListObjects("l_tbl_FAC_Details").DataBodyRange.Value
    Dim PREFIX_SOMMAIRE_TEC As String
    PREFIX_SOMMAIRE_TEC = "*** - [Sommaire des TEC] pour la facture - "

    Dim i As Long, facture As String, heures As Currency

    For i = 2 To UBound(arrFAC, 1)
        facture = Trim(arrFAC(i, fFacDInvNo))
        If Len(facture) > 0 Then
            If Left(CStr(arrFAC(i, fFacDDescription)), Len(PREFIX_SOMMAIRE_TEC)) = PREFIX_SOMMAIRE_TEC Then
            heures = arrFAC(i, fFacDHeures)
                If dictHresFactureesFACDetails.Exists(facture) Then
                    dictHresFactureesFACDetails(facture) = dictHresFactureesFACDetails(facture) + heures
                Else
                    dictHresFactureesFACDetails.Add facture, heures
                End If
            End If
        End If
    Next i

    'Vérification des heures facturées selon 2 dictionary (TEC_Local vs. FAC_Details)
    Dim key As Variant
    Dim totalHoursBilled As Currency
    Dim hresFactureesTEC As Currency
    Dim hresFactureesFAC As Currency
    Dim cas_Heures_Differentes As Integer
    
    For Each key In dictFacture.keys
        hresFactureesFAC = dictHresFactureesFACDetails(key)
        hresFactureesTEC = dictHresFactureesTEC(key)
        If Not hresFactureesFAC = hresFactureesTEC Then
            Call AjouterMessage(wsOutput, r, 2, "********** Facture '" & CStr(key) & _
                    "', il y a un écart d'heures facturées entre TEC_Local & FAC_Details - " & _
                        Round(hresFactureesTEC, 2) & " vs. " & Round(hresFactureesFAC, 2))
            isTECvalid = False
            gNombreErreur = gNombreErreur + 1
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:ComparerHeuresFactureesSelon2Sources", _
...
Sub ImprimerSommaireHeuresTEC(ByVal wsOutput As Worksheet, ByRef r As Long, _
    ...
    Dim startTime As Double: startTime = Timer
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:ImprimerSommaireHeuresTEC", vbNullString, 0)
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:ImprimerSommaireHeuresTEC", _
                            vbNullString, startTime)
...
Sub ImprimerSommaireDateProf(ByVal wsOutput As Worksheet, ByRef r As Long, _
    ...
    Dim startTime As Double: startTime = Timer
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:ImprimerSommaireDateProf", vbNullString, 0)
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:ImprimerSommaireDateProf", _
                            vbNullString, startTime)
...
Sub ImprimerSommaireTimeStampProf(ByVal wsOutput As Worksheet, ByRef r As Long, _
    ...
    Dim startTime As Double: startTime = Timer
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:ImprimerSommaireTimeStampProf", vbNullString, 0)
    ...
    Call modDev_Utils.EnregistrerLogApplication("modVerifications:ImprimerSommaireTimeStampProf", _
                            vbNullString, startTime)
    ...
    If Len(invNo) > 0 Then
        ...
        If invNo <> "Radiation" Then
            If Not dictFacture.Exists(invNo) Then
                ...
                isValid = False
            Else
                'Accumuler les heures dans dictHresFactureesTEC
                If dictHresFactureesTEC.Exists(invNo) Then
                    dictHresFactureesTEC(invNo) = dictHresFactureesTEC(invNo) + data(i, fTECHeures)
                Else
                    dictHresFactureesTEC.Add invNo, data(i, fTECHeures)
                End If
            End If
        End If
    Else
...
Public Sub ReporterAnomalie(wsOutput As Worksheet, r As Long, mess1 As String, mess2 As String, _
                                                                                        mess3 As String)
    
    Call AjouterMessageAuxResultats(wsOutput, r, 2, mess1)
    
    If mess2 <> vbNullString Then
        r = r + 1
        Call AjouterMessageAuxResultats(wsOutput, r, 2, Space(10) & mess2)
    End If
    
    If mess3 <> vbNullString Then
        r = r + 1
        Call AjouterMessageAuxResultats(wsOutput, r, 2, Space(10) & mess3)
    End If
...
Public Sub AjouterMessage(ws As Worksheet, ByRef r As Long, ByRef c As Long, message As String)
