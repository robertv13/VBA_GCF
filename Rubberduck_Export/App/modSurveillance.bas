...
Sub VerifierActivite() '2025-11-06 @ 15:57
    ...
    If Not Fn_ActiviteDetectee() Then
...
Function Fn_ActiviteDetectee() As Boolean '2025-11-06 @ 15:57

    Dim startTime As Double: startTime = Timer
    Call modDev_Utils.EnregistrerLogApplication("modSurveillance:Fn_ActiviteDetectee", vbNullString, 0)
    
    Fn_ActiviteDetectee = False
...
FIN_VERIFICATION:
    ...
    If Fn_ActiviteDetectee = False Then
    ...
    Call modDev_Utils.EnregistrerLogApplication("modSurveillance:Fn_ActiviteDetectee", vbNullString, _
                                                        startTime)
    ...
    For Each ctrl In frm.Controls
        ...
        Select Case TypeName(ctrl)
            Case "TextBox"
                ...
                Set wrapper.txt = ctrl
            Case "ComboBox"
                Set wrapper = New clsWrapperComboBox
                Set wrapper.cmb = ctrl
            Case "CommandButton"
...
'    Application.WindowState = xlNormal
    ...
    Set fermetureAuto = New clsFermetureAuto
    Call fermetureAuto.FermerApplicationDansXSecondes(gDELAI_GRACE_SECONDES)
...
Sub zz_TesterFermeture() '2025-11-08 @ 06:37
