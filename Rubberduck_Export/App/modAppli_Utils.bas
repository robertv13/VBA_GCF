...
Private Sub VerifierENCEntete(ByRef r As Long, ByRef readRows As Long)
    ...
    Call AddMessageToWorkSheet(wsOutput, r, 2, "Analyse de '" & ws.Name & "' ou 'wsdENC_Entete'")
    r = r + 1
...
Private Sub VerifierFACEntete(ByRef r As Long, ByRef readRows As Long)
    ...
    Call AddMessageToWorkSheet(wsOutput, r, 2, "Analyse de '" & ws.Name & "' ou 'wsdFAC_Entete'")
    r = r + 1
...
Private Sub VerifierFACProjetsEntete(ByRef r As Long, ByRef readRows As Long)
    ...
    Call AddMessageToWorkSheet(wsOutput, r, 2, "Analyse de '" & ws.Name & "' ou 'wsdFAC_Projets_Entete'")
    r = r + 1
...
Private Sub VerifierTEC(ByRef r As Long, ByRef readRows As Long)
    ...
    lastTECIDReported = 7461 'What is the last TECID analyzed ?
