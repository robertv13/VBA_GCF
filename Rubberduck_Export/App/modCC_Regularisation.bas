...
Sub MAJ_Regularisation() '2025-01-14 @ 12:00
    ...
    Dim startTime As Double: startTime = Timer: Call Log_Record("modCC_Regularisation:MAJ_Regularisation", vbNullString, 0)
...
Clean_Exit:
    ...
    Call Log_Record("modCC_Regularisation:MAJ_Regularisation", vbNullString, startTime)

End Sub

Sub Régularisation_Add_New() '2024-08-21 @ 14:58

    Dim startTime As Double: startTime = Timer: Call Log_Record("modCC_Regularisation:Régularisation_Add_New", vbNullString, 0)

    Call ENC_Clear_Cells
    
    Call Log_Record("modCC_Regularisation:Régularisation_Add_New", vbNullString, startTime)
    
End Sub

Sub REGUL_Add_DB() 'Write to MASTER.xlsx
    
    Dim startTime As Double: startTime = Timer: Call Log_Record("modCC_Regularisation:REGUL_Add_DB", vbNullString, 0)
    ...
    Call Log_Record("modCC_Regularisation:REGUL_Add_DB", vbNullString, startTime)
    
End Sub

Sub REGUL_Add_Locally() '2024-08-22 @ 10:38
    
    Dim startTime As Double: startTime = Timer: Call Log_Record("modCC_Regularisation:REGUL_Add_Locally", vbNullString, 0)
    ...
    Call Log_Record("modCC_Regularisation:REGUL_Add_Locally", vbNullString, startTime)

End Sub

Sub REGUL_Update_Comptes_Clients_DB() 'Write to MASTER.xlsx
    
    Dim startTime As Double: startTime = Timer: Call Log_Record("modCC_Regularisation:REGUL_Update_Comptes_Clients_DB", vbNullString, 0)
    ...
    Call Log_Record("modCC_Regularisation:REGUL_Update_Comptes_Clients_DB", vbNullString, startTime)
    
End Sub

Sub REGUL_Update_Comptes_Clients_Locally() '2024-08-22 @ 10:55
    
    Dim startTime As Double: startTime = Timer: Call Log_Record("modCC_Regularisation:REGUL_Update_Comptes_Clients_Locally", vbNullString, 0)
    ...
    Call Log_Record("modCC_Regularisation:REGUL_Update_Comptes_Clients_Locally", vbNullString, startTime)

End Sub

Sub REGUL_GL_Posting_DB(no As Long, dt As Date, nom As String, desc As String)
    
    Dim startTime As Double: startTime = Timer: Call Log_Record("modCC_Regularisation:REGUL_GL_Posting_DB", vbNullString, 0)
    ...
    Call Log_Record("modCC_Regularisation:REGUL_GL_Posting_DB", vbNullString, startTime)

End Sub

Sub REGUL_GL_Posting_Locally(no As Long, dt As Date, nom As String, desc As String)  'Write/Update to GCF_BD_MASTER / GL_Trans
    
    Dim startTime As Double: startTime = Timer: Call Log_Record("modCC_Regularisation:REGUL_GL_Posting_Locally", vbNullString, 0)
    ...
    Call Log_Record("modCC_Regularisation:REGUL_GL_Posting_Locally", vbNullString, startTime)
