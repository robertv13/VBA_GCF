...
'Importation des clients ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â  partir de ... \DataConversion\Clients.xlsx
Sub zz_CopierClientsEntreClasseursFermes() '2024-08-03 @ 09:40
    ...
    'DÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©finir les chemins d'accÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨s des fichiers (source & destination)
    Dim sourceFilePath As String
    sourceFilePath = "C:\VBA\GC_FISCALITÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°\DataConversion\Clients.xlsx"
    ...
    'DÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©termine la derniÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨re rangÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e utilisÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e dans le fichier Source
    ...
    MsgBox "Les donnÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©es ont ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©tÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â© copiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©es avec succÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨s dans le fichier destination."
...
Sub zz_ImporterDonneesDeClasseursFermesTEC() '2024-08-14 @ 06:43 & 2024-08-03 @ 16:15
    ...
    strFilePath = "C:\VBA\GC_FISCALITÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°\DataConversion\TEC_20240814.xlsx"
...
'        client = Mid$(client, InStr(client, " - ") + 3, Len(client))
    ...
    If errorMesg <> vbNullString Then
        MsgBox errorMesg
    Else
        MsgBox "Tous les TEC ont ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©tÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â© importÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©s, pour un total de " & totHres & " heures"
    End If
...
'Importation des fournisseurs ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â  partir de ... \DataConversion\Fournisseurs.xlsx
Sub zz_ImporterDonneesDeClasseursFermesFournisseurs() '2024-08-03 @ 18:10
    ...
    'DÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©finir les chemins d'accÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨s des fichiers (source & destination)
    Dim sourceFilePath As String
    sourceFilePath = "C:\VBA\GC_FISCALITÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°\DataConversion\Fournisseurs.xlsx"
    Dim destinationFilePath As String
    destinationFilePath = wsdADMIN.Range("PATH_DATA_FILES").Value & gDATA_PATH & Application.PathSeparator & wsdADMIN.Range("CLIENTS_FILE").Value
    ...
    MsgBox "Les donnÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©es (fournisseurs) ont ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©tÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â© copiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©es avec succÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨s dans" & vbNewLine & _
...
Sub zz_ImporterDonneesDeClasseursFermesGL() '2024-08-03 @ 18:20
    ...
    'Define the path to the closed workbook
    Dim strFilePath As String
    strFilePath = "C:\VBA\GC_FISCALITÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°\DataConversion\GL_BV.xlsx"
    Dim strSheetName As String
    strSheetName = "BV$"
    Dim strRange As String
    ...
    Dim No_EntrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e As Long
    No_EntrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e = 1
    ...
    Do Until recSet.EOF
        ...
        wsDest.Range("A" & rowNum).Value = No_EntrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e
    ...
    MsgBox "Tous les soldes ont ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©tÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â© importÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©s, pour un total dÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©bit de " & totalDT & _
                vbNewLine & vbNewLine & "un total crÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©dit de " & totalCT
...
Sub zz_ImporterDonneesDeClasseursFermes_CAR() '2024-08-04 @ 07:31
    ...
    'Define the path to the closed workbook
    Dim strFilePath As String
    strFilePath = "C:\VBA\GC_FISCALITÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°\DataConversion\CAR.xlsx"
    Dim strSheetName As String
    strSheetName = "CAR$"
    Dim strRange As String
    ...
    If errorMesg <> vbNullString Then
        MsgBox errorMesg
    Else
        MsgBox "Tous les CAR ont ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©tÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â© importÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©s, pour un total de " & Format$(totCAR, "#,##0.00$")
    End If
...
Sub zz_AjusterNomClientDansTEC() '2024-08-03 @ 09:40
    ...
    'DÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©finir les chemins d'accÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨s des fichiers (source & destination)
    Dim sourceFilePath As String
    sourceFilePath = "C:\VBA\GC_FISCALITÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°\DataFiles\GCF_BD_Master.xlsx"
    Dim clientMF As String
    clientMF = "C:\VBA\GC_FISCALITÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°\DataFiles\GCF_BD_EntrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e.xlsx"
...
Sub zz_CheckClientName() '2024-08-10 @ 10:13
    ...
    'DÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©finir les chemins d'accÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨s des fichiers (source & destination)
    Dim sourceFilePath As String
    sourceFilePath = "C:\VBA\GC_FISCALITÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°\DataFiles\GCF_BD_EntrÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e.xlsx"
    ...
    MsgBox "Les donnÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©es ont ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©tÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â© vÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©rifiÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©es avec succÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨s dans le fichier Clients."
    
End Sub

Sub CorrigerNomClientDansTEC()  '2025-03-04 @ 05:48

    'Source - DÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©finir les chemins d'accÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨s des fichiers, le Workbook, le Worksheet et le Range
    Dim sourceFilePath As String
    ...
    'DÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©termine la derniÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨re rangÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e et derniÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨re colonne utilisÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©es dans wsdTEC_Local
    ...
    wsOutput.Range("A" & rowOutput).Value = "**** " & Format$(lastUsedRowTEC - 1, "###,##0") & _
                                        " lignes analysÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©es dans l'ensemble du fichier ***"
    ...
    MsgBox "Il y a " & casDelta & " cas oÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¹ le nom du client (TEC) diffÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨re" & _
            vbNewLine & vbNewLine & "du nom de client du Fichier MAÃƒÆ’Ã†â€™Ãƒâ€¦Ã‚Â½TRE", vbInformation
...
Public Sub CorrigerNomClientDansCAR()  '2024-08-31 @ 06:52
    ...
    For i = 2 To lastUsedRowClientMF
        'EnlÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨ve les informations de contact
    ...
    wsOutput.Range("E1").Value = "ChangÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â© pour"
    ...
    For Each ws In Array("FAC_Entete|4|6", "FAC_Comptes_Clients|4|3")
        ...
        'DÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©termine la derniÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨re rangÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e utilisÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©e dans la feuille
        Dim lastUsedRow As Long
...
Sub zz_ImporterDonneesManquantes_CAR() '2024-08-24 @ 15:58
    ...
    Dim wb1 As Workbook
    Set wb1 = Workbooks.Open("C:\VBA\GC_FISCALITÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°\DataFiles\GCF_BD_MASTER - Copie.xlsx")
    Dim wb2 As Workbook
    Set wb2 = Workbooks.Open("C:\VBA\GC_FISCALITÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°\DataFiles\GCF_BD_MASTER.xlsx")
    ...
    MsgBox "Le traitement est complÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©tÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©", vbInformation
...
Sub zz_FusionnerDonneesManquantes_CAR() '2024-08-29 @ 07:29
    ...
    'Declare and open the 2 workbooks
    Dim wb1 As Workbook
    Set wb1 = Workbooks.Open("C:\VBA\GC_FISCALITÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°\GCF_DataFiles\CAR_A_COMPLÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°TER.xlsx")
    Dim wb2 As Workbook
    Set wb2 = Workbooks.Open("C:\VBA\GC_FISCALITÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°\DataFiles\GCF_BD_MASTER.xlsx")
    ...
    For i = 2 To lastUsedRow
        ...
        If foundCells Is Nothing Then
            MsgBox "**** Je n'ai pas trouvÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â© la facture '" & invNo & "' dans wsdFAC_Entete", vbCritical
        Else
            ii = foundCells.row
        End If
        
        If ws2.Cells(ii, 21).Value <> arTotal Then
            MsgBox "ProblÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨me d'intÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©gritÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â© pour la facture '" & invNo & "' au niveau de arTotal", vbCritical
        End If
        ...
        If ws2.Cells(ii, 10) + ws2.Cells(ii, 12) + ws2.Cells(ii, 14) + ws2.Cells(ii, 16) + _
            ...
            MsgBox "ProblÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¨me avec les assignations...", vbCritical
        End If
