...
'
'    ' Create the UserForm
'    Dim frm As frmSaisieHeures
'    Set frm = UserForms.Add("frmSaisieHeures")
'
'    ' Assign the range of data to the UserForm
'    frm.ListData = shImportedClients.Range("A1").CurrentRegion
'
...
Sub FilterProfDate()
    ...
    'Filtered worksheet should only show the filtered records
