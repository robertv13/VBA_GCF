...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmSaisieHeures 
   ...
   ClientTop       =   456
   ClientWidth     =   13044
   OleObjectBlob   =   "frmSaisieHeures_v0.7_20230322_1218.frx":0000
...
Sub txtDate_AfterUpdate()
    ...
    If Len(strDate) = 0 Then
        strDate = currentYear & "-" & currentMonth & "-" & currentDay
    ElseIf Len(strDate) <= 2 Then
        strDate = Format(strDate, "00") & "-" & currentMonth & "-" & currentYear
    ElseIf Len(strDate) = 5 Then
        strDate = strDate & "-" & currentYear
    End If
