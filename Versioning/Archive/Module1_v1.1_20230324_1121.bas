...
Sub AjouteLigneDetail()
    ...
    'MsgBox IsDate(frmSaisieHeures.txtDate.value) & "" _
        & frmSaisieHeures.txtDate.value
    Dim formatedDate As Date
    formatedDate = CDate(frmSaisieHeures.txtDate.value)
    MsgBox IsDate(formatedDate) & " " & formatedDate
    ...
    With sh
        ...
        .Range("C" & lastRow + 1).value = Format(formatedDate, "yyyy-mm-dd")
