...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} UserFormBook 
   ...
   ClientTop       =   648
   ClientWidth     =   11136
   OleObjectBlob   =   "UserFormCompany_20230303_0137.frx":0000
...
Private Sub UserForm_Initialize()
    ...
    With oEventHandler
        ...
        TextBox1.Font.Size = 11                                                 'RMV - 2023-03-03 @ 01:04
...
Private Sub CheckBoxShowMatches_Click()
    ...
    If Not oEventHandler Is Nothing Then
        oEventHandler.ShowAllMatches = False 'CheckBoxShowMatches.value - RMV - 20230303 @ 01:15
    End If
End Sub
